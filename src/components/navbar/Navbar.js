        ...
        <>
            <Flex boxShadow={"xl"} bg="whiteAlpha.200" flexDir={'row'} alignItems={'center'} justifyContent={'space-between'} w="100%" p={4} color="black">
                ...
                <Flex justifyContent={'center'} flex="1">
                    <Link to='/help'><Button m={2}>   <FaHandsHelping /><Text ml={2}> </Text>Find Help</Button> </Link>
                    <Link exact to='/'><Button m={2}> <FaHandHoldingHeart /> <Text ml={2}></Text>Provide Help</Button ></Link>
                    <Link to='/organization'><Button m={2}> <VscOrganization /><Text ml={2}></Text> Organizations</Button></Link>
                ...
                <Flex flex="1" flexDir="row-reverse">
                    ...
                    <Link to='/new-post'><Button m={2} onClick={() => { setauth(!auth) }} colorScheme="green">New Post</Button></Link>
                </Flex>
            </Flex>
        </>
