...
import { FaHandHoldingHeart, FaHandsHelping, VscOrganization } from "react-icons/all";
  ...
  return (
    <div className="navbar" >
      ...
      >
        ...
        <Flex justifyContent={"space-between"} flex={["1","2","2"]} w={['100%']} maxW="700px">
         
         
          <NavbarButton icon={FaHandsHelping} number="0" name="Find Help" to="/help" />
          <NavbarButton icon={FaHandHoldingHeart} number="1" name="Provide Help" to="/provide-help" />
          <NavbarButton icon={VscOrganization} number="2" name="Organizations" to="/organization" />
